...
PHONICS_DATA = [
    ...
    {'letter': 'G', 'sound': 'g', 'word': 'Guitar', 'emoji': '🎸'},
    {'letter': 'H', 'sound': 'h', 'word': 'Hat', 'emoji': '🎩'},
    {'letter': 'I', 'sound': 'i', 'word': 'Igloo', 'emoji': '🏔️'},
    {'letter': 'J', 'sound': 'j', 'word': 'Juice', 'emoji': '🧃'},
